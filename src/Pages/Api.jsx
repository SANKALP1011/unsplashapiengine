...
export const Api = () =>{
 ...
 return <>
    ...
    <input type="text" value={image} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  onChange={(e)=>{setImage(e.target.value)}}/>
   ...
   <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
     {result.map((value)=>{
       return<>
        ...
        {isModalVisible && <CardModal setIsModalVisible={setModalVisible} id={value.id}  Name={value.user.name}/>}
        </div>
        </>
      })}
   </div>
